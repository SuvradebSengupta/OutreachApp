...
<body>
	...
	<div id="event">
		...
		<c:url value="/admin-view-event" var="pagedLink">
					...
					<c:forEach items="${pagedListHolder.pageList}" var="events">
						<tbody id="myTable">
							<tr>
								...
								<td><a href="/admin-event-info?id=${events.id}"
									class="btn btn-success">Event Details</a></td>
								<td><a href="/admin-donate-event?id=${events.id}"
