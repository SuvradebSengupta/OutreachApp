...
<body>
	...
	<div id="event">
		...
		<c:url value="/volunteer-list" var="pagedLink">
			<c:param name="p" value="~" />
		</c:url>

		<h1 class="text-center text-white pt-5">Volunteer List</h1>
		<div class="text-center pt-5">
			<label class="text-white">Search for Volunteer:</label> <input
		...
		<div class="container">
			<div id="login-box" class="col-md-12">
				<table class="table table-striped">
					...
					<c:forEach items="${pagedListHolder.pageList}" var="volunteerList">
						<tbody id="myTable">
							<tr>
								<td>${volunteerList.volunteerId}</td>
								<td>${volunteerList.username}</td>
							</tr>
						</tbody>
					</c:forEach>
				</table>
