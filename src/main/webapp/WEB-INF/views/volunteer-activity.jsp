...
<body>
	...
	<div id="search">
		<form id="login-form" class="form" action="" method="post">
			<label for="activity" class="text-center text-info">Search
				by Activity: </label> <select name="activity" id="activity" required>
			...
			</select><br> <br> &emsp;<input type="submit" onclick="return validate()"
				name="submit" value="Search" class="btn btn-info btn-lg">
			&emsp;&emsp;
		</form>
	</div>
	<script
