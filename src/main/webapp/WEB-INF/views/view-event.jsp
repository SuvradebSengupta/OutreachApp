...
<title>Volunteer | View Event</title>
<link
					...
					<c:forEach items="${pagedListHolder.pageList}" var="events">
						<tbody id="myTable">
							<tr>
								...
								<td><a href="/join-event?id=${events.id}"
									class="btn btn-success">Join</a></td>
								<td><a href="/invite" class="btn btn-info">Invite</a></td>
								<td><a href="/donate-event?id=${events.id}"
									class="btn btn-warning">Donate</a></td>
							</tr>
						</tbody>
					</c:forEach>
				</table>
